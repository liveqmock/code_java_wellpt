 ...
 */
@Component
public class ReceivedManageDataSource extends AbstractDataSourceProvider {
	@Autowired
	...
	public List<QueryItem> query(Set<DataSourceColumn> dataSourceColumn, String whereHql, Map<String, Object> queryParams, String orderBy,
		...
		String sql = " zfmt0003 a"
			...
			+ " left join zfmt0007 e on a.bukrs=e.bukrs and a.kunnr=e.kunnr"
			+ " where "
			+ whereHql;
		if(!isFicoAdmin()){
			sql+=" and e.zrname ='"+getUserCode()+"'";
		}
