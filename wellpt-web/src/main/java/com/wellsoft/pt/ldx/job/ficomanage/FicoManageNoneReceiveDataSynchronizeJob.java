 ...
 *
 */
public class FicoManageNoneReceiveDataSynchronizeJob implements Job {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		try {
			ficoManageService.saveZfmt0016FromSapSys();
			ficoManageService.saveZfmt0016LogWeekly();
			ficoManageService.saveZfmt0016LogMonthly();
