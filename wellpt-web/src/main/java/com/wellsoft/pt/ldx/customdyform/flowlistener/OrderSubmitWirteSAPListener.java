...
@Service
@Transactional
public class OrderSubmitWirteSAPListener implements TaskListener{
	...
	public void onCompleted(Event event) throws WorkFlowException {
		...
		for(Map<String,Object> child:childList){
			...
			param.append("',ZPSDAT1:'");param.append(dateformat.format(now));// 订单评审提交日期
			param.append("',ZPSTIM1:'");param.append(timeformat.format(now));// 订单评审提交时间
			param.append("',ETTYP:'"); 
