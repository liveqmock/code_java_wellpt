...
@Service
@Transactional
public class TravelWirteSAPListener implements TaskListener{
	...
	public void onCompleted(Event event) throws WorkFlowException {
		...
		for(Map<String,Object> child:childList){
			...
			params.append("',PI_AWART:'0003'}");// 类型（0001：外出办事，0002：外出培训，0003：出差）
