...
@Service
@Transactional
public class AssetsWirteCheckListener implements TaskListener{
	...
	public void onCompleted(Event event) throws WorkFlowException {
		...
		for(Map<String,Object> child:childList){
			...
			if(targetData==null){
				...
				targetData.put("ztgs",dataMap.get("ztgs"));
				...
				targetData.put("jkry",dataMap.get("ysry"));
				targetData.put("gdzch",child.get("sapgdzcbh"));
				targetData.put("mc",child.get("gzmc"));
				targetData.put("xhgg",child.get("ggxh"));
				targetData.put("sccj",child.get("zzcs"));
