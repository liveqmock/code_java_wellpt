...
(function($){
	...
	$.wFileUploadMethod={
	    	...
	    	isAttachCtl:function(){
	    		if(this.options.commonProperty.inputMode==dyFormInputMode.accessory3 || this.options.commonProperty.inputMode==dyFormInputMode.accessory1
	    				|| this.options.commonProperty.inputMode==dyFormInputMode.accessoryImg		
	    		){
	    			return true;
	    		}else{
	    			return false;
