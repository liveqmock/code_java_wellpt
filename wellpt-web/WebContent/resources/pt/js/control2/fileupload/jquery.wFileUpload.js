...
(function($) {
	...
	FileUpload.prototype = {
		...
		init : function() {
			...
			/*if(this.getDataUuid()!=''&&this.getDataUuid()!=undefined && !this.options.columnProperty.data){
				//初始化上传控件 
			...
			this.fileuploadobj.init(setReadOnly,  $attachContainer,  this.options.enableSignature, mutiselect, files);
			//}
			 // this.addMustMark();
		},
		 //设置hide属性
