...
$(function() {
	...
	$("#list").jqGrid({
		url : ctx + '/common/jqgrid/query?serviceName=workDoneService',
		mtype : 'POST',
		datatype : "json",
		...
		ondblClickRow : function(id) {
			...
			if (rowData.taskUuid != null && rowData.taskUuid != "") {
				window.open(ctx + '/workflow/work/view/done?taskUuid=' + rowData["taskUuid"], "_blank");
			}
		},
	...
	$("#btn_todo_view").click(function() {
		...
		window.open(ctx + "/workflow/work/view/done?taskUuid=" + bean["taskUuid"], "_blank");
	});
