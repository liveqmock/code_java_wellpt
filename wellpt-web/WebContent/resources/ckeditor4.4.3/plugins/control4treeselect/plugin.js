(function() {
	...
	var pluginName =  CkPlugin.TREESELECTCTL;
    CKEDITOR.plugins.add(pluginName, {
        requires: ["dialog"],
        init: function(a) { 
        	 a.focusedDomPropertyUrl4TreeSelect =  this.path + "dialogs/" + pluginName + ".html";//属性窗口中的html对应的地址,dysubform.js中要使用到该变量
        	 a.imageOfTreeSelectctl = getRelativePath(this.path) + "images/treeselectctl.jpg" ;
        	 //定义"设置从表"对话框
