(function() {
    ...
    CKEDITOR.plugins.add(pluginName, {
        requires: ["dialog"],
        init: function(a) { 
        	 a.focusedDomPropertyUrl4FileUpload =  this.path + "dialogs/" + pluginName + ".html";//属性窗口中的html对应的地址,dysubform.js中要使用到该变量
        	 a.imageOfFileUploadctl = getRelativePath(this.path) + "images/fileuploadctl.jpg" ;
        	 //定义"设置从表"对话框
            ...
            a.ui.addButton(pluginName, {
                label: "列表式附件上传控件",//调用dialog时显示的名称
                command: pluginName,
