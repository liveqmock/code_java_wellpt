(function() {
    ...
    CKEDITOR.plugins.add(pluginName, {
        requires: ["dialog"],
        init: function(a) { 
        	 a.focusedDomPropertyUrl4Checkbox =  this.path + "dialogs/" + pluginName + ".html";//属性窗口中的html对应的地址,dysubform.js中要使用到该变量
        	 a.imageOfCheckboxctl = getRelativePath(this.path) + "images/checkboxctl.jpg" ;
        	 //定义"设置从表"对话框
