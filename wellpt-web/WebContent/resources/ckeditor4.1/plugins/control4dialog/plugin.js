(function() {
    ...
    CKEDITOR.plugins.add(pluginName, {
        requires: ["dialog"],
        init: function(a) { 
        	 a.focusedDomPropertyUrl4Dialog =  this.path + "dialogs/" + pluginName + ".html";//属性窗口中的html对应的地址,dysubform.js中要使用到该变量
        	 a.imageOfDialogctl = getRelativePath(this.path) + "images/dialogctl.jpg" ;
        	 //定义"设置从表"对话框
