...
(function() {
    ...
    function A(a) {
        for (var a = a.toUpperCase(), c = B.length, b = 1, f = 1; 0 < a.length; f *= c) b += B.indexOf(a.charAt(a.length - 1)) * f,
    ...
    z = [[1E3, "M"], [900, "CM"], [500, "D"], [400, "CD"], [100, "C"], [90, "XC"], [50, "L"], [40, "XL"], [10, "X"], [9, "IX"], [5, "V"], [4, "IV"], [1, "I"]],
    ...
    E = CKEDITOR.plugins.pastefromword = {
        utils: {
            ...
            resolveList: function(a) {
                ...
                c.style && (c.style = E.filters.stylesFilter([["text-indent"], ["line-height"], [/^margin(:?-left)?$/, null,
                function(a) {
                    a = a.split(" ");
                    a = CKEDITOR.tools.convertToPx(a[3] || a[1] || a[0]); ! s && (null !== t && a > t) && (s = a - t);
                    t = a;
            ...
            getStyleComponents: function() {
                ...
                return function(c, b, f) {
                    ...
                    for (var c = {},
                    b = f.length,
                    d = 0; d < b; d++) c[f[d]] = a.getStyle(f[d]);
                    return c
                }
            } (),
        ...
        filters: {
            flattenList: function(a, c) {
                ...
                e, h = 0; h < d.length; h++) if (e = d[h], e.name in CKEDITOR.dtd.$listItem) {
                    var j = e.attributes,
                    g = e.children,
                    m = g[g.length - 1];
                    ...
                    E.filters.stylesFilter([["tab-stops", null,
                    function(a) { (a = a.split(" ")[1].match(H)) && (t = CKEDITOR.tools.convertToPx(a[0]))
                    }], 1 == c ? ["mso-list", null,
                    function(a) {
                        a = a.split(" ");
            ...
            assembleList: function(a) {
                ...
                b, f, d, e, h, j, a = [], g, m, i, l, k, p, n = 0; n < c.length; n++) if (b = c[n], "cke:li" == b.name) if (b.name = "li", f = b.attributes, i = (i = f["cke:listsymbol"]) && i.match(/^(?:[(]?)([^\s]+?)([.)]?)$/), l = k = p = null, f["cke:ignored"]) c.splice(n--, 1);
                else {
                    f["cke:reset"] && (j = e = h = null);
                    d = Number(f["cke:indent"]);
                    d != e && (m = g = null);
                    if (i) {
                        if (m && x[m][g].test(i[1])) l = m,
                        k = g;
                        else for (var q in x) for (var u in x[q]) if (x[q][u].test(i[1])) if ("ol" == q && /alpha|roman/.test(u)) {
                            if (g = /roman/.test(u) ? y(i[1]) : A(i[1]), !p || g < p) p = g,
                            l = q,
                            k = u
                        } else {
                            l = q;
                    ...
                    if (j) {
                        if (d > e) a.push(j = new CKEDITOR.htmlParser.element(l)),
                        j.add(b),
                        h.add(j);
                        else {
                            if (d < e) {
                        ...
                        c.splice(n--, 1)
                    } else a.push(j = new CKEDITOR.htmlParser.element(l)),
                    j.add(b),
                    c[n] = j;
                    h = b;
                    e = d
                ...
                for (n = 0; n < a.length; n++) if (j = a[n], q = j.children, g = g = void 0, u = j.children.length, r = g = void 0, c = /list-style-type:(.*?)(?:;|$)/, e = CKEDITOR.plugins.pastefromword.filters.stylesFilter, g = j.attributes, !c.exec(g.style)) {
                    for (h = 0; h < u; h++) if (g = q[h], g.attributes.value && Number(g.attributes.value) == h + 1 && delete g.attributes.value, g = c.exec(g.attributes.style)) if (g[1] == r || !r) r = g[1];
                    else {
                        r = null;
                        break
                    }
                    if (r) {
                        for (h = 0; h < u; h++) g = q[h].attributes,
        ...
        getRules: function(a, c) {
            ...
            return {
                ...
                elements: {
                    ...
                    $: function(a) {
                        ...
                        if (v.match(/h\d/)) {
                            ...
                            if (q(a)) return;
                            g(d["format_" + v])(a)
                        } else if (v in b.$inline) a.filterChildren(c),
                        n(a) && delete a.name;
                    ...
                    style: function(a) {
                        if (CKEDITOR.env.gecko) {
                            var a = (a = a.onlyChild().value.match(/\/\* Style Definitions \*\/([\s\S]*?)\/\*/)) && a[1],
                            c = {};
                            a && (a.replace(/[\n\r]/g, "").replace(/(.+?)\{(.+?)\}/g,
                            function(a, b, F) {
                                for (var b = b.split(","), a = b.length, d = 0; d < a; d++) CKEDITOR.tools.trim(b[d]).replace(/^(\w+)(\.[\w-]+)?$/g,
                                function(a, b, d) {
                                    b = b || "*";
                ...
                attributes: {
                    style: j(s ? [[/^list-style-type$/, null], [/^margin$|^margin-(?!bottom|top)/, null,
                    function(a, b, c) {
                        if (b.name in {
                            p: 1,
                            div: 1
                    ...
                    }], [/^margin$/, D], ["text-indent", "0cm"], ["page-break-before"], ["tab-stops"], ["display", "none"], o ? [/font-?/] : null], s),
                    width: function(a, c) {
