...
<div class="form_header">
	...
	<div id="toolbar" class="form_toolbar">
		<div class="form_operate">
			...
			<button id="btn_forward" type="button" class="btn btn-primary"><spring:message code="exchange.btn.forward" /></button>
		</div>
	</div>
</div>
...
<script type="text/javascript" src="${ctx}/resources/exchange/js/inbox_v1.js"></script>
