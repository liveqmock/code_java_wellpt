...
<body>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>
					<i class="icon-edit"></i> <spring:message code="exchange.label.supervise.moduleName" />
				</h2>
				<div class="box-icon">
			...
			<div class="box-content">
				...
				<form id="search_form" class="well form-inline" method="post"
					action="">
					<div class="btn-group">
						<button id="btn_view" type="button" class="btn"><spring:message code="exchange.btn.view" /></button>
					</div>
				</form>
				<div id="table">
					<table id="supervise_list"></table>
					<div id="pager"></div>
				</div>
	...
	<script type="text/javascript"
		src="${ctx}/resources/exchange/js/supervise.js"></script>
</body>
</html>