...
<body>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>
					<i class="icon-edit"></i> <spring:message code="exchange.label.inbox.moduleName" />
				</h2>
				<div class="box-icon">
	...
	<div id="dialog-forceSignature">
	    <form>
	        <label for="forceSignatureName">请输入姓名</label>
	        <input type="text" name="forceSignatureName" id="forceSignatureName" class="text ui-widget-content ui-corner-all" />
	    </form>
	</div>
	...
	<script type="text/javascript"
		src="${ctx}/resources/exchange/js/inbox.js"></script>
</body>
</html>