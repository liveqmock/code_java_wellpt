...
<body>
	...
	<script>
		function dodel(uuid) {
			window.open("${ctx }/worktask/plan/view.action?uuid=" + uuid);
...
<%-- 				<form action="${ctx }/worktask/task/list_share.action" method="post"> --%>
<!-- 					<div> -->
<!-- 						<input type="text" name="username"  id="username" -->
<%-- 							value="${username }" /> <input type="hidden" name="userId" --%>
