	...
	<div class="div_body" style="">
		<div class="form_header" style="">
			...
			<div id="toolbar" class="form_toolbar">
				<div class="form_operate">
					<button id="form_audit_pass" type="button">审核通过</button>
					<button id="form_audit_nopass" type="button">审核不通过</button>
		...
		<form action="" id="wlgcform" class="dyform">
			...
			<table>
				<tbody>
					<tr>
						<td class="title" colspan="4">订单审核</td>
					</tr>
					<tr class="field">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#form_audit_nopass").click(function() {
			if ($("#wlgcform").validate(Theme.validationRules).form()) {
				$("#wlgcform").form2json(bean);
				collectChildrenDatadicList(bean);
				JDS.call({
					service : "dmsOrderService.auditNoPass",
					data : [ bean ],
					async : false,
					success : function(result) {
						window.opener.reloadFileParentWindow();
