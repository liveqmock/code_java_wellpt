...
<h2  style="width: 257px; border-bottom: 1px solid #FFFFFF;
    border-left: medium none;
    margin-left: -185px;font-size: 18px;margin-top: 17px;">
    <div style="text-align: left;letter-spacing: 14px;">厦门市审批服务云</div>
     <div style="text-align: left;font-size: 14px; letter-spacing: 5px;">厦门市建设项目联合审批平台</div>
    </h2>
...
<%-- 	${ctx}/${user.photoUrl} --%>
	...
	<li><a href="${ctx}/cms/cmspage/readPage?uuid=7f2f78e0-024b-4c18-be87-915c337aa445&treeName=MESSAGE_XZSP_JJ&mid=2014228163647814&moduleid=01c72d84-753a-43de-8475-b87527c8a693"><img class="member_message" src="${ctx}/resources/theme/images/v1_icon_message.png" />我的消息<sup class="num"  style="right: 17px;">0</sup></a></li>
</ul>

<ul class="top-nav">
		<li><a href="${ctx}/cms/cmspage/readPage?uuid=7f2f78e0-024b-4c18-be87-915c337aa445&treeName=NOTICE_JJGL&mid=2014228163647814&moduleid=f4d40a24-6e1b-4056-9bfb-6b8e97e7fed2">审批业务</a></li>
		<li><a href="${ctx}/cms/cmspage/readPage?uuid=7f2f78e0-024b-4c18-be87-915c337aa445&treeName=PROJECT_REGISTER&mid=2014228163647814&moduleid=23056193-7eca-452a-85ac-308e7b02977b">项目注册</a></li>
		<li><a href="${ctx}/cms/cmspage/readPage?uuid=7f2f78e0-024b-4c18-be87-915c337aa445&treeName=ZLXZ_JJGL&mid=2014228163647814&moduleid=f7fdc929-6b99-4987-84fb-437d349f4c0b">综合查询</a></li>
		<li><a href="${ctx}/cms/cmspage/readPage?uuid=7f2f78e0-024b-4c18-be87-915c337aa445&treeName=CJWT_JJGL&mid=2014228163647814&moduleid=f7fdc929-6b99-4987-84fb-437d349f4c0b">统计报表</a></li>
</ul>
