...
<c:forEach var="cmsCategory" items="${cmsCategorys}" varStatus="status">
	<div class="home menu nav-list-div" style="float: left">
		...
		<c:if test="${cmsCategory.cc.id !='YPT_GJL_SYBZ_SSGL' || ${cmsCategory.cc.id !='YPT_GJL_SYBZ_XZSP'}">
			<c:if test="${empty cmsCategory.cc.inputUrl}">
				<a>11123123${cmsCategory.cc.title}</a>
			</c:if>
			<c:if test="${!empty cmsCategory.cc.inputUrl}">
				<a href="${ctx}${cmsCategory.cc.inputUrl}">12312312312${cmsCategory.cc.title}</a>
			</c:if>
...
<ul class="item_map">
	...
	<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=0d02d22a-f08c-4dd5-9f24-1101a7d2b588&amp;treeName=DOCUMENT_MANAGEMENT"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_12.png" />文件管理</a></li>
...
<div class="oa_map_l">
<ul class="item_map">
	<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=c645ba94-a0d0-48f3-9ef4-a04624b548e8&amp;treeName=SCHEDULE_CATE&amp;mid=20136199117335&amp;moduleid=055acade-425b-453f-8cfb-a6dc71ffa29b"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_3.png" />个人日程</a></li>
	<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=c645ba94-a0d0-48f3-9ef4-a04624b548e8&amp;treeName=SCHEDULE2_CATE&amp;mid=20136199117335&amp;moduleid=49464d20-cb6f-4d25-b384-5531777bd784"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_10.png" />领导日程</a></li>
	...
	<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=b0ab6a0a-7e70-47b4-bf48-213dcce041b3&amp;201466153924205=2d031b61-f6f3-48b8-afc8-4a34400529a9&amp;20146615397140=e250430a-99d4-47ae-8646-4a230659d802#"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_4.png" />事项管理</a></li>
</ul>
</div>
...
<ul class="item_map">
	...
	<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=666d0f04-7200-47f7-82d3-f85c495d8ce1&amp;treeName=MEET_CATE&amp;mid=20136315910846&amp;moduleid=e4b52d6e-fbc6-448e-aaa8-a313a74005b8"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_20.png" />会议管理</a></li>
	<!--<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=666d0f04-7200-47f7-82d3-f85c495d8ce1&amp;treeName=EXCHANGE&amp;mid=20136315910846&amp;moduleid=fc379458-24ba-4872-ad3b-853ba2e03d7a"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_21.png" />公文交换</a></li>
<li class="item_map"><a class="item_map" href="${ctx}/cms/cmspage/readPage?uuid=666d0f04-7200-47f7-82d3-f85c495d8ce1&amp;treeName=DATA_MANAGEMENT&amp;mid=20136315910846&amp;moduleid=99143bf3-ac1d-434e-87ca-690156d86fe8"><img alt="" class="item_map" src="${ctx}/resources/theme/images/icon/m_14.png" />资料管理</a></li>
