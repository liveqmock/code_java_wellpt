...
--%>
<h1 style="width: 230px;background:url('${ctx}/resources/pt/img/zzffzx-logo4.png') no-repeat 0 1px;height: 60px;cursor: auto;" >&nbsp;</h1>
<h2  style="width: 273px; border-bottom: 1px solid #FFFFFF;
    border-left: medium none;
    margin-left: -185px;font-size: 18px;margin-top: 17px;">
    <div style="text-align: left;letter-spacing:3px;">厦门市行政审批信息管理平台</div>
     <div style="text-align: left;font-size: 14px;letter-spacing: 2px;">厦门市建设项目审批信息管理系统
</div>
    </h2>
<!-- <h1><a href="#">威尔软件</a></h1> -->
<!--     <h2>统一业务应用与开发云平台</h2> -->
...
<!-- 	<i class="member-info-show"> </i> -->
	...
	<a class="member-info-show" href="${ctx}/security_logout">注销</a>
	</div>
	</div>
	</div>
	</li>
	...
	<li style="width:50px;"><a href="${ctx}/security_logout"><img class="member_message" src="${ctx}/resources/theme/images/v1_icon_user4.png" />&nbsp;&nbsp;&nbsp;注销</a></li>
</ul>				
</c:if>
...
<ul class="top-nav">
	<c:forEach var="cmsCategory" items="${cmsCategorys}" varStatus="status">
		<c:if test="${cmsCategory.cc.code!='XZSP_JJGXT'}">
			<li><div><a href="${ctx}${cmsCategory.cc.inputUrl}">${cmsCategory.cc.title}</a></div></li>
		</c:if>	
	</c:forEach>
</ul>
