...
<%-- 	${ctx}/${user.photoUrl} --%>
	...
	<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&treeName=SSGL_WDXX&2013121917168553=01c72d84-753a-43de-8475-b87527c8a693"><img class="member_message" src="${ctx}/resources/theme/images/v1_icon_message.png" />我的消息<sup class="num"  style="right: 17px;">0</sup></a></li>
</ul>

<ul class="top-nav">
	<c:forEach var="cmsCategory" items="${cmsCategorys}" varStatus="status">
		<li><a href="${ctx}${cmsCategory.cc.inputUrl}">${cmsCategory.cc.title}
		<c:if test="${cmsCategory.cc.code=='SSGL_TB_DSH'}"><sup class="num1"  style="right: -5px;top: -15px;">${SSGL_TB_DSH_COUNT}</sup></c:if></a></li>
	</c:forEach>
</ul>
