...
<%-- 	${ctx}/${user.photoUrl} --%>
	...
	<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&treeName=MESSAGE_SSGL1&mid=2013121917168553&moduleid=01c72d84-753a-43de-8475-b87527c8a693"><img class="member_message" src="${ctx}/resources/theme/images/v1_icon_message.png" />我的消息<sup class="num"  style="right: 17px;">0</sup></a></li>
</ul>
...
<%-- 		<c:if test="${xzspDSHStatus=='yes' }"> --%>
<%-- 			<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&mid=2013121917168553&moduleid=687f2327-4166-45c2-8002-697d73f6c0e5&treeName=SJSH_XZSP">待审核<sup class="num1"  style="right: -5px;top: -15px;">${xzspDSHNum}</sup></a></li> --%>
<%-- 		</c:if> --%>
<%-- 		<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&mid=2013121917168553&moduleid=d99e693f-fa1e-4c1f-914d-6835e59f2128&treeName=JJFK_SSGL">监察反馈</a></li> --%>
<%-- 		<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&treeName=NOTICE_SSGL&mid=2013121917168553&moduleid=f17ff76b-c520-4ec7-bccc-a881f4bf82fc">通知公告</a></li> --%>
<%-- 		<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&treeName=ZCFG_SSGL&mid=2013121917168553&moduleid=bf213f05-98a7-481b-ae8a-a364dfd802cb">政策法规</a></li> --%>
<%-- 		<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&treeName=ZLXZ_SSGL&mid=2013121917168553&moduleid=4ff33d74-3e6e-4c51-99c8-0474f2830a45">资料下载</a></li> --%>
<%-- 		<li><a href="${ctx}/cms/cmspage/readPage?uuid=851ca01d-6e5b-41d8-aa1f-082ed72c4598&treeName=CJWT_SSGL&mid=2013121917168553&moduleid=29ba9f2e-1622-4128-bfff-8a668715e5a1">常见问题</a></li> --%>
</ul>
