...
<body>
			...
			<div>
				<div class="btn-group  btn-group-top">
					<div class="query-fields">
						<input id="query_keyWord" type="hidden"/>
		...
		<div class="ui-layout-center">
			<div>
				<form action="" id="excel_export_rule_form" name="excel_export_rule_form" enctype='multipart/form-data'>
				<div class="tabs">
					<ul>
					...
					<div id="tabs-1">
						...
						<table>
							...
							<tr>
								<td><label>来源视图</label></td>
								<td>
									<input class="full-width" type="text" id="viewName" name="viewName" datatype="*" nullmsg="必填项"/>
									<input id="viewUuid" name="viewUuid" type="hidden"/>
								</td>
								<td><div class="Validform_checktip"></div></td>
							</tr>
							<tr>
	...
	<div id="columnValue" title="列值设置" style="display:none">
		<table>
			<tr>
				...
				<td width="50">
				<input id="columnBasic" name="columnBasic" type="checkbox"
									/></td>
				<td><div id="columnValue_basic" >
	...
	<script type="text/javascript"
		src="${ctx}/resources/pt/js/basicdata/excelexportrule/excelexportrule.js"></script>
</body>
</html>