...
<body>
	...
	<div class="ui-layout-center" >
		<iframe frameborder="0" width="100%" height="100%" name="categoryprivilegeIf" id="categoryprivilegeIf" 
		src="${ctx}/security/privilege"></iframe>
	</div>
	...
	<script type="text/javascript" src="${ctx}/resources/pt/js/security/category_privilege.js"></script>
