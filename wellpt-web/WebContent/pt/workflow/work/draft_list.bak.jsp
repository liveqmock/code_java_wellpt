...
<script type="text/javascript" src="${ctx}/resources/pt/js/global.js"></script>
	...
	$().ready(function(){
		$("#view").click(function(){
			var row = $('#work_draft').datagrid('getSelected');
			if (row) {
				TabUtils.openTab(row['flowInstUuid'], row['name'], ctx + '/workflow/work/view?flowInstUuid=' + row['flowInstUuid']);
			} else {
...
<body style="width:100%; height:100%;padding:0px; margin:0px;">
	...
	<table id="work_draft" title="工作草稿" class="easyui-datagrid" style="height:350px"
			url="${ctx}/workflow/work/draft/list.action"
