...
<body>
		...
		<div>
			<div class="btn-group btn-group-top">
				<div class="query-fields">
					<input id="query_category" name="query_category" />
				...
				<div class="tabs">
					...
					<div id="tabs-1">
						<table>
							...
							<!-- 								<td><input id="parentName" name="value" type="text" /></input></td> -->
							<!-- 								<td><input id="parentUuid" name="value" type="hidden" /></input></td> -->
							<!-- 							</tr> -->
						</table>
					</div>
				</div>
	...
	<script type="text/javascript"
		src="${ctx}/resources/pt/js/workflow/category.js"></script>
</body>
</html>