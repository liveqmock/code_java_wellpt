...
<form:form id="form" commandName="format" method="post" action="${ctx}/workflow/define/format/${action}" cssClass="cleanform">
	<c:if test="${not empty format.uuid}">
    ...
    <table>
        ...
        <tr>
			<td><label>格式内容</label></td>
        	<td><form:input path="value"></form:input></td>
        	<td><form:errors path="value" cssClass="error" /></td>
        </tr>
        <tr>
			<td><label>清除HTML格式</label></td>
        	<td><form:checkbox path="isClear"></form:checkbox></td>
        	<td><form:errors path="isClear" cssClass="error" /></td>
        </tr>
        <tr>
            <td></td>
