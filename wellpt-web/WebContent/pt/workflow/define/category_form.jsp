...
<form:form id="form" commandName="category" method="post" action="${ctx}/workflow/define/category/${action}" cssClass="cleanform">
	<c:if test="${not empty category.uuid}">
    ...
    <table>
        ...
        <tr>
			<td><label>上级分类</label></td>
        	<td><form:input path="parentCode"></form:input></td>
        	<td><form:errors path="parentCode" cssClass="error" /></td>
        </tr>  
        <tr>  
            <td></td>  
