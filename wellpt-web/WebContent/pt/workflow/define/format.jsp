...
<body>
		...
		<div>
			<div class="btn-group btn-group-top">
				<div class="query-fields">
					<input id="query_format" name="query_format" />
				...
				<div class="tabs">
					...
					<div id="tabs-1">
						<table>
							...
							<tr>
								<td></td>
								<td><input id="isClear" name="isClear" type="checkbox"
									value="false" /><label for="isClear">清除HTML格式</label></td>
								<td></td>
							</tr>
						</table>
					</div>
	...
	<script type="text/javascript"
		src="${ctx}/resources/pt/js/workflow/format.js"></script>
</body>
</html>