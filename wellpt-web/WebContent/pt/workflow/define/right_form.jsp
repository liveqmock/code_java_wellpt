...
<form:form id="form" commandName="right" method="post" action="${ctx}/workflow/define/right/${action}" cssClass="cleanform">
	<c:if test="${not empty right.uuid}">
    ...
    <table>
        ...
        <tr>  
        	...
        	<td><form:checkbox path="isDefault" /></td>
        	<td><form:errors path="isDefault" cssClass="error" /></td>
        </tr>
        <tr>
            <td></td>
