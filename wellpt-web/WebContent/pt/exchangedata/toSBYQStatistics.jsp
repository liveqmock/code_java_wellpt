	...
	<div class="viewContent">
		...
		<table style="margin: 0px 6px;width: 343px;border-collapse:collapse;">
			<tr style="background: none repeat scroll 0 0 #E7EBF1;line-height: 35px;text-align: left;">
			    ...
			    <td class="value" style="border:1px solid #D9D9D9;width:30%;padding-left:6px;">逾期数量</td>
			</tr>
			
			<c:forEach items="${sbyqStatisticsMapList}" var="sbyqStatisticsMapItem" > 
			    <c:forEach items="${sbyqStatisticsMapItem}" var="entry"> 
