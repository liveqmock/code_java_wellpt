					...
					<div id="tabs">
						...
						<div id="tabs-1">
							<table  style="width: 100%;">
								<tr>
									<td><label>环节</label></td>
									<td><input id="node" name="node" type="text" style="width:100%;"/></td>
								</tr>
								<tr>
								...
								<tr>
									<td>统一查询号</td>
									<td><input id="dataId" name="dataId" type="text" style="width:100%;"/></td>
								</tr>
								<tr>
									<td>版本号</td>
									<td><input id="recVer" name="recVer" type="text" style="width:100%;"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input id="status" name="status" type="text" style="width:100%;"/></td>
								</tr>
								<tr>
...
<!-- 						<button id="btn_save" type="button" class="btn">保存</button> -->
	...
	<script type="text/javascript"
		src="${ctx}/resources/pt/js/exchangedata/exchangelog.js "></script>
