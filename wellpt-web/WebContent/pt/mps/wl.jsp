...
<form action="../mps/findwl"  method="post"  class="dyform"/>
<table>
...
<td width="90px">物料编码</td>
<td width="110px"><input type="text" name="wlcd" style="border:0;width:100%;height:90%;" /></td>
</tr>
<tr>
<td width="90px">物料描述</td>
<td width="110px"><input type="text" name="wlms" style="border:0;width:100%;height:90%;" /></td>
<td width="90px">是否有效</td>
<td width="110px">
<select name="ys" style="border:0;width:100%;height:90%;">
<option></option>
<option>Y</option>
<option>N</option>
</select>
...
<thead>
<tr>
<td class="title" colspan="11">物料查询明细报表</td>
</tr>
<tr width="80px" class="ui-jqgrid-labels">
...
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">单位</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">制造/采购</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">WIP供应类型</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">关键组件标识</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">需要质检</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">条码管理</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">是否有效</th>
</tr>
</thead>
<tbody>
...
<input type="text"   value="物料查询报表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px;"  class="smartBtn"/>
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/wl"%></textarea>
</form>
<%
}
%>
