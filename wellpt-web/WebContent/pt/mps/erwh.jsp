...
<form action="../mps/finderwh"  method="post"  class="dyform" />
<table>
...
<td width="90px">异常代码编号</td>
<td width="110px"><input type="text" name="yc"  style="border:0;width:100%;height:90%;" /></td>
...
<thead>
<tr>
<td class="title" colspan="11">异常工时明细报表</td>
</tr>
...
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">异常代码编号</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">异常代码描述</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">异常工时</th>
...
<input type="text"   value="异常工时明细表查询"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px" class="smartBtn" />
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/erwh"%></textarea>
</form>
