...
<form action="../mps/findwnode"  method="post"   class="dyform"/>
<table>
...
<td width="90px">线别</td>
<td width="110px"><input type="text"  name="xt" style="border:0;width:100%;height:90%;"/></td>
<td width="90px">工单号</td>
<td width="110px"><input type="text"  name="gd" style="border:0;width:100%;height:90%;" /></td>
</tr>
<tr>
<td width="90px">用户ID</td>
<td width="110px"><input type="text" name="uid"  style="border:0;width:100%;height:90%;" /></td>
<td width="90px">不良代码ID</td>
<td width="110px"><input type="text" name="wn" style="border:0;width:100%;height:90%;" /></td>
<td width="90px">不良描述</td>
<td width="110px"><input type="text" name="wds" style="border:0;width:100%;height:90%;"  /></td>
...
<thead>
<tr>
<td class="title" colspan="10">工单查询明细报表</td>
</tr>
...
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">不良代码ID</th>
...
<input type="text"   value="场景不良代码明细查询"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px" class="smartBtn" />
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/wnode"%></textarea>
</form>
<%
}
%>
