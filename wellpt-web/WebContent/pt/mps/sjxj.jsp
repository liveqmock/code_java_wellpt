...
function tj(){
	 ...
	 if(document.getElementById('jytype').value!="")
...
function  dfirst(){
	    ...
	    document.ts.action="../mps/first"
		document.ts.submit();
	
}
function dlast(){
	
	document.ts.action="../mps/last"
	document.ts.submit();
...
String time1=ss.format(new Date());   
Calendar calendar = Calendar.getInstance();
calendar.add(Calendar.DAY_OF_YEAR, 1);
Date date = calendar.getTime();
String time2=ss.format(date);
%>


<% List ls=(List)request.getAttribute("list");  
   List ls2=(List)request.getAttribute("list2");
...
<div class="div_body" >
 ...
 <form action="../mps/findsjxj"  method="post"  id="find" name="find" class="dyform"/>
 <table >		
	<tr>
					<td  class="title" colspan="16">查询</td>
     </tr>
...
<tr class="field">
<td width="90px">检验类型</td>
<td width="110px">
<select name="jytype" id="jytype"  style="background-color:yellow;border:0;width:100%;height:90%; ">
<option></option>
<%while (itr.hasNext()){ %>
<option><%=((String)itr.next()).trim() %></option>
<%
}
%>
</select>
</td>
<td width="90px">检验批号</td>
<td width="110px"><input type="text"  name="jyph" style="border:0;width:100%;height:90%;" /></td>
<td width="90px">生产订单</td>
<td width="110px"><input type="text" name="ddh"   style="border:0;width:100%;height:90%;"/></td>
<td width="90px">课别</td>
<td width="110px"><input type="text"  name="kb"   style="border:0;width:100%;height:90%;" /></td>
</tr>

<tr class="field">
<td width="90px">创建时间</td>
<td width="10px" >从</td>
<td width="110px"><input type="text" name="time1" id="time1" onclick="MyCalendar.SetDate(this)"  style="border:0;width:100%;height:90%;" value=<%=time1%> /></td>
<td width="10px" > 至   </td>
<td width="110px"><input type="text" name="time2" id="time2" onclick="MyCalendar.SetDate(this)"   style="border:0;width:100%;height:90%;"  value=<%=time2%> /></td>
<td width="90px">销售订单</td>
<td width="110px"><input type="text"  name="xs"   style="border:0;width:100%;height:90%;" /></td>
<td width="90px">工单号</td>
<td width="110px"><input type="text"  name="gd"   style="border:0;width:100%;height:90%;" /></td>
</tr>
<tr class="field">
<td width="90px">线别</td>
<td width="110px"><input type="text"  name="xb"   style="border:0;width:100%;height:90%;" /></td>
<td width="90px">客户简称</td>
<td width="110px"><input type="text"  name="guest"  style="border:0;width:100%;height:90%;" /></td>
<td width="90px">SO行项目</td>
<td width="110px"><input type="text"  name="soh"  style="border:0;width:100%;height:90%;" /></td>
<td width="90px">班次</td>
<td width="110px"><input type="text"  name="bc"  style="border:0;width:100%;height:90%;" /></td>
<td><input type="button"  onclick="tj()" value="查询" /></td>
</tr>
</table>
...
<%
String bj=(String)request.getAttribute("bj");
%>
<%if(bj.equals("-1")){  %>
初始页面未进行任何的查询 
<%
...
<%
	...
	int total=(Integer)request.getAttribute("totalnum");	
	String[][] result=(String[][])request.getAttribute("result"); 
	int po=(Integer)request.getAttribute("po");
	int pages=(Integer)request.getAttribute("page");
	int tps=total>po?total/po:1;
	if(tps!=1){
	int ts=total%po>0?1:0;
	tps+=ts;
	}

%>
<table style="margin-top: 4px;width: 2500px;">
<thead>
<tr>
<td class="title" colspan="20">工单查询明细报表</td>
</tr>
<tr class="ui-jqgrid-labels">
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">生产工厂</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">工厂描述</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">生产课别描述</th>
<th  width="80px"  class="ui-state-default ui-th-column ui-th-ltr">线别描述</th>
<th   width="80px"  class="ui-state-default ui-th-column ui-th-ltr">生产班次</th>
<th width="80px"   class="ui-state-default ui-th-column ui-th-ltr">工单ID</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">检验批号</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">物料编码</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">物料段描述</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">客户简称</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">销售订单</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">SO行项目</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">创建人</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">创建时间</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">工序号</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">关键工序</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">检查项目</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">检查结果</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">判定</th>
<th   width="80px"  class="ui-state-default ui-th-column ui-th-ltr">信息文本</th>
</tr>
</thead>
<tbody>
  <%for(int i=(pages-1)*po;i<pages*po&&i<total;i++)  {%>
  <tr>
...
<div style="width:100%;float:right;height:100%;">
			<div style="float:left;height: 100%;">
				...
				第<%=pages%>页,共<%=tps%>页,每页<%=po%>条,共<%=total%>条 
				</label>
			</div>
			<div style="float:right;height: 100%;">
					<button type="button" class="smartBtn" id="B_First" style="width:60px;" onclick="dfirst()">首页</button>
					<button type="button" class="smartBtn" id="B_Previous" style="width:60px;" onclick="dup()">上一页</button>
				</span>
				<span align="right" id="wwctrl_B_Next">
					<button type="button" class="smartBtn" id="B_Next" style="width:60px;" onclick="ddown()">下一页</button>
					<button type="button" class="smartBtn" id="B_Last" style="width:60px;" onclick="dlast()">末页</button>
				</span>
			</div>
		</div>
<table></table>
...
<% String a=(String)request.getAttribute("tjshuju") ;%> 
<form action="../exdown" method="post">
<textarea name="tjshuju" style="display:none">
<%=a%>  
</textarea>
<input type="text"   value="首检巡检查询报表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载"  style="width:80px;height:30px;"  class="smartBtn" />
</form>

 <form action="" name="ts" method="post">
       <textarea name="shuju" style="display:none"><%=a%></textarea>
       <textarea name="page" style="display:none"><%=pages%></textarea>
       <textarea name="op" style="display:none"><%=po%></textarea>
       <textarea name="adr" style="display:none"><%="/mps/sjxj"%></textarea>
</form>
<%
}
%>
