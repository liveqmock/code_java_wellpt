...
<form action="../mps/findcrtime"  method="post"  class="dyform"/>
<table>
...
<thead>
<tr>
<td class="title" colspan="12">生产工时明细报表</td>
</tr>
<tr class="ui-jqgrid-labels">
<th width="90px" class="ui-state-default ui-th-column ui-th-ltr">采集时间</th>
...
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">类别</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">员工号</th>
<th  width="90px" class="ui-state-default ui-th-column ui-th-ltr">开工时间</th>
<th  width="90px" class="ui-state-default ui-th-column ui-th-ltr">完工时间</th>
...
<input type="text"   value="生产工时明细报表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载"  class="smartBtn" />
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/crtime"%></textarea>
</form>
<%
}
%>
