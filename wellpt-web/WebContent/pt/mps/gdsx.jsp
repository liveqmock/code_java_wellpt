...
<form action="../mps/findgdsx"  method="post"  class="dyform"/>
<table>
	<tr>
	       <td class="title" colspan="16">查询条件</td>
	</tr>
...
<td>采集时间</td>
<td>从 </td>
<td><input type="text" name="time1" id="time1" onclick="MyCalendar.SetDate(this)"   style="border:0;width:100%;height:90%;"  value=<%=time1%> /></td>
<td> 到 </td>
<td><input type="text" name="time2" id="time2" onclick="MyCalendar.SetDate(this)"   style="border:0;width:100%;height:90%;" value=<%=time2%> /></td>
<td>物料编码</td>
...
<thead>
<tr>
<td class="title" colspan="10">工单上线明细表</td>
</tr>
...
<th   width="80px"  class="ui-state-default ui-th-column ui-th-ltr">WKC</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">WKC描述</th>
...
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">上线时间</th>
</tr>
</thead>
<tbody>
...
<input type="text"   value="工单上线查询报表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px ;"  class="smartBtn"/>
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/gdsx"%></textarea>
</form>
<%
}
%>
