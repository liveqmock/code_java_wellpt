...
<form action="../mps/cxsj"  method="post"  class="dyform"/>
<table>
    		
<tr>
<td class="title"  colspan="13">查询</td>
</tr>

<tr  class="field">

<td width="90px;">采集时间</td>
<td>从</td>
...
<td width="90px">工厂</td>
<td width="110px"><input type="text" name="comp" style="border:0;width:100%;height:90%;" /></td>
<td width="90px">工单号</td>
<td width="110px"><input type="text" name="gd" style="border:0;width:100%;height:90%;"/></td>
</tr>
<tr>
<td width="90px">员工号</td>
<td width="110px"><input type="text" name="yg" style="border:0;width:100%;height:90%;"/></td>
<td width="90px">场景</td>
<td width="110px"><input type="text" name="cj" style="border:0;width:100%;height:90%;"/></td>
<td width="90px">课别</td>
<td width="110px"><input type="text" name="kb" style="border:0;width:100%;height:90%;"/></td>
<td width="90px">物料ID</td>
<td width="110px"><input type="text" name="wid" style="border:0;width:100%;height:90%;"/></td>
...
<thead>
<tr>
<td class="title" colspan="12">生产实际工时统计表</td>
</tr>
<tr class="ui-jqgrid-labels">
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">工厂</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">员工号</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">部门</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">课别</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">线别</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">工单号</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">场景</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">班次</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">开工时间</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">完工时间</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">物料ID</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">实际工时</th>
</tr>
</thead>
<tbody>
...
<input type="text"   value="生产实际工时统计表 "   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px" class="smartBtn" />
</form>
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/cxsj"%></textarea>
</form>
<%
}
%>
