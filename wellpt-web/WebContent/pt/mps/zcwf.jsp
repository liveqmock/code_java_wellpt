...
<form action="../mps/findzcwf"  method="post" class="dyform"/>
<table>
	<tr>
	     <td class="title" colspan="13">查询条件</td>
	</tr>
<tr class="field">
...
<td width="90px">缺陷类别</td>
<td  width="110px"><input type="text" name="lb" style="border:0;width:100%;height:90%;" /></td>
...
<thead>
<tr>
<td class="title" colspan="10">制程不良查询报表</td>
</tr>
...
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">不良代码</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">不良代码描述</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">缺陷类别</th>
</tr>
</thead>
<tbody>
...
<div style="width:100%;float:right;height:100%;">
			<div style="float:left;height: 100%;">
				...
				第<%=pages%>页,共<%=tps%>页,每页<%=po%>条,共<%=total%>条, 不良代码总条数为<%=total%>
				</label>
			</div>
...
<input type="text"   value="制程不良查询统计表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px;" class="smartBtn" />
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/zcwf"%></textarea>
</form>
