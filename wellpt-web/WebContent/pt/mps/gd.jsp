...
function downexcel(){
	...
	function dfind(){
		...
		//alert(document.getElementById('gx').value);
...
<form action="../mps/findgd"  method="post"  class="dyform"/>
<table>
...
<td>采集时间</td>
<td>从</td>
<td> <input type="text" name="time1" id="time1" onclick="MyCalendar.SetDate(this)"   value=<%=time1%> style="border:0;width:100%;height:90%;" /></td>
<td> 到 </td>
<td><input type="text" name="time2" id="time2" onclick="MyCalendar.SetDate(this)"  value=<%=time2%> style="border:0;width:100%;height:90%;" /></td>
<td>工厂</td>
<td><input type="text"  name="gc" style="border:0;width:100%;height:90%;"  /></td>

<td>工单</td>
<td><input type="text" name="gd" style="border:0;width:100%;height:90%;" /></td>
</tr>
<tr>
<td>产线</td>
<td><input type="text" name="cx" style="border:0;width:100%;height:90%;" /></td>
<td>物料编码</td>
<td><input type="text"  name="wlcd" style="border:0;width:100%;height:90%;" /></td>
<td>物料描述</td>
<td><input type="text"  name="wlms" style="border:0;width:100%;height:90%;" /></td>
...
%>
<table style="margin-top: 4px;width: 2200px;">
<thead>
<tr>
<td class="title" colspan="15">工单查询明细报表</td>
</tr>
<tr   class="ui-jqgrid-labels">
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">工厂</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">生产线</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">生产线描述</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">工单号</th>
<th width="80px"  class="ui-state-default ui-th-column ui-th-ltr">生产订单号</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">销售订单号</th>
<th width="100px"  class="ui-state-default ui-th-column ui-th-ltr">物料编码</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">物料描述</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">状态</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">计划数量</th>
<th width="80px" class="ui-state-default ui-th-column ui-th-ltr">完工数量</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">报废数量</th>
<th  width="100px" class="ui-state-default ui-th-column ui-th-ltr">开始时间</th>
<th  width="100px" class="ui-state-default ui-th-column ui-th-ltr">结束时间</th>
<th  width="80px" class="ui-state-default ui-th-column ui-th-ltr">完工子库</th>
</tr>
</thead>
<tbody>
...
<input type="text"   value="工单查询报表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载"  class="smartBtn" />
</form>
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/gd"%></textarea>
</form>
<%
}
%>
