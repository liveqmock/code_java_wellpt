...
<div class="div_body" >
 ...
 <form action="../mps/findstaff"  method="post"  class="dyform" name="find">
    	<table>
    		<tbody>
    			<tr>
					<td class="title" colspan="12">查询</td>
				</tr>
<tr class="field">
<td width="90px;">采集时间</td><td width="10px">从</td> <td width="110px;"><input type="text" name="time1" id="time1" onclick="MyCalendar.SetDate(this)"   style="border:0;width:100%;height:90%;"  value=<%=time1%> /> </td>
<td width="10px">到</td><td width="110px;"> <input type="text" name="time2" id="time2" onclick="MyCalendar.SetDate(this)"  style="border:0;width:100%;height:90%;" value=<%=time2%> /></td>
<td width="90px;">工单号</td>
<td width="110px;"><input type="text"  name="gd"  style="border:0;width:100%;height:90%;" id="gd" /></td>
<td width="90px;">用户ID</td>
<td width="110px;"><input type="text" name="uid"  style="border:0;width:100%;height:90%;" id="uid" /></td>
<td width="90px;">工序号</td>
<td width="110px;"><input type="text" name="gx" style="border:0;width:100%;height:90%;" id="gx" /></td>
<td width="80px;"><div class="form_operate"> <input type="button"  value="查询" style="width:40px;margin-bottom:10px; " onclick="dfind()" /> </div></td>
</tr>
</table>
...
<thead>
	   			<tr>
					<td class="title" colspan="9">员工报工明细表</td>
				</tr>
<tr  class="ui-jqgrid-labels">
<th   width="80px"  class="ui-state-default ui-th-column ui-th-ltr">采集时间</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">工单号</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">用户ID</th>
<th   width="80px"  class="ui-state-default ui-th-column ui-th-ltr">报工数量</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">机台GID</th>
<th   width="80px" class="ui-state-default ui-th-column ui-th-ltr">机台DID</th>
...
for(int i=0;i<total;i++)
	totalnum+=Double.parseDouble(result[i][3]);
%>
...
%>
    ...
    <% String a=(String)request.getAttribute("tjshuju") ;%> 
      <form action="../exdown" method="post" name="exdown">
      <textarea name="tjshuju" style="display:none"><%=a%></textarea>
      <input type="text"   value="员工报工明细表查询"   name="sj" style="display:none" />
       <input type="button"  value="报表下载"   class="smartBtn" onclick="downexcel()"/>
      </form>
      ...
      <textarea name="adr" style="display:none"><%="/mps/staff"%></textarea>
      </form>
<%
}
%>
