...
<form action="../mps/finderwhtj"  method="post" class="dyform"/>
<table>		
<tr>
<td class="title" colspan="20" >查询</td>
</tr>
<tr class="field">
...
<td width="90px">工厂</td>
<td width="110px"><input type="text"  name="gc" style="border:0;width:100%;height:90%;"/></td>
<td width="90px">部门</td>
<td width="110px"><input type="text" name="bm" style="border:0;width:100%;height:90%;"/></td>
</tr>
<tr class="field">
<td width="90px">课别</td>
...
<td width="90px">异常代码</td>
<td width="110px"><input type="text" name="yc1" style="border:0;width:100%;height:90%;"/></td>
<td width="90px">异常代码描述</td>
<td width="110px"><input type="text" name="yc2" style="border:0;width:100%;height:90%;"/></td>
<td width="110px"><input type="submit"  /></td>
</tr>
</table>
...
<thead>
<tr>
<td class="title" colspan="11">异常工时统计表</td>
</tr>
<tr class="ui-jqgrid-labels">
<th  class="ui-state-default ui-th-column ui-th-ltr">工厂</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">部门</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">课别</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">线别</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">工单号</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">场景</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">班次</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">异常工时</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">时间</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">异常代码</th>
<th  class="ui-state-default ui-th-column ui-th-ltr">异常代码描述</th>
</tr>
</thead>
<tbody>
<%
for(int i=0;i<total;i++) 
	tsd+=Double.parseDouble(result[i][result[i].length-4]);
...
<div style="width:100%;float:right;height:100%;">
			<div style="float:left;height: 100%;">
				...
				第<%=pages%>页,共<%=tps%>页,每页<%=po%>条,共<%=total%>条 ,异常工时统计<%=tsd %>
				</label>
			</div>
...
<input type="text"   value="异常工时统计表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px" class="smartBtn" />
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/erwhtj"%></textarea>
</form>
