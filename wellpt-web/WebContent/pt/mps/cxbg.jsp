...
<form action="../mps/cxbg"  method="post"  class="dyform" />
<table>
	<tr>
...
<thead>
<tr>
<td class="title" colspan="8">产线报工明细表</td>
</tr>
...
<th width="90px" class="ui-state-default ui-th-column ui-th-ltr">报工时间</th>
</tr>
</thead>
<tbody>
<%
for(int i=0;i<total;i++)
	totalnum+=Double.parseDouble(result[i][6]);
%>
...
<div style="width:100%;float:right;height:100%;">
			<div style="float:left;height: 100%;">
				...
				第<%=pages%>页,共<%=tps%>页,每页<%=po%>条,共<%=total%>条 ,报工统计总数量<%=totalnum %>
				</label>
			</div>
...
<input type="text"   value="产量明细查询报表"   name="sj" style="display:none" />
<input type="submit"  value="报表下载" style="margin-left:5px;"  class="smartBtn"/>
 ...
 <form action="" name="ts" method="post">
       ...
       <textarea name="adr" style="display:none"><%="/mps/cxbg"%></textarea>
</form>
<%
}
%>
