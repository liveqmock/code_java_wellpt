...
<!--     margin-left: -270px;font-size: 18px;margin-top: 17px;"> -->
<!--     <div style="text-align: left;letter-spacing: 15px;">厦门市审批服务云</div> -->
<!--      <div style="text-align: left;font-size: 14px;">厦门市行政审批信息管理平台</div> -->
<!--     </h2> -->
</div>
