...
<head>
	...
	<script src="${ctx}/resources/pt/js/global.js" type="text/javascript"></script>
	<script src="${ctx}/resources/pt/js/common/jquery.alerts.js" type="text/javascript"></script>
	<script src="${ctx}/resources/pt/js/org/unit/jquery.unit.js" type="text/javascript" ></script>
	<script src="${ctx}/resources/schedule/schedule.js" type="text/javascript"></script>
	<script src="${ctx}/resources/schedule/global_zh_CN.js" type="text/javascript"></script>
