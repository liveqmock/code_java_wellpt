...
// 				url:"${ctx}/schedule/person_schedule2.action",
// 				success:function(result){
// 					$(".schedule_person_list2").html(result);
// 				}
// 			});
// 		}else{
// 			window.location.href='${ctx}/schedule/person_schedule2.action?ldate='+ldate+'&stype=1&mtype='+mtype;
// 		}
// 	});
	//下一天
...
// 			});
// 		}else{
// 			window.location.href='${ctx}/schedule/person_schedule2.action?ldate='+ldate+'&stype=2&mtype='+mtype;
// 		}
// 	});
	//月
