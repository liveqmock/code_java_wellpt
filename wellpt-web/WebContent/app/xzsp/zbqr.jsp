	...
	<div class="dyform zbqr_form">
		...
		<table style="width: 100%">
			...
			<tr>
				...
				<td class="value" colspan="3"><select name="zbqr_opinion_value"
					id="zbqr_opinion_value" style="width: 100%;">
			...
			<tr class="odd row_zbqr_send_msg_content" style="display: none;">
				...
				<td class="value" colspan="3"><textarea
						id="zbqr_send_msg_content" name="zbqr_send_msg_content" rows="5"
