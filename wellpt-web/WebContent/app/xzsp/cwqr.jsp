	...
	<div class="dyform cwqr_form">
		...
		<table style="width: 100%">
			...
			<tr>
				...
				<td class="value" colspan="3"><select name="cwqr_opinion_value"
					id="cwqr_opinion_value" style="width: 100%;">
			...
			<tr class="odd row_cwqr_send_msg_content" style="display: none;">
				...
				<td class="value" colspan="3"><textarea
						id="cwqr_send_msg_content" name="cwqr_send_msg_content" rows="5"
