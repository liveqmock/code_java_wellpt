...
public class ViewColumnNew {
	...
	private ViewColumnTypeNew columnType;//列类型
	 ...
	 */
	public ViewColumnTypeNew getColumnType() {
		return columnType;
	}
	 ...
	 */
	public void setColumnType(ViewColumnTypeNew columnType) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ViewColumnNew other = (ViewColumnNew) obj;
		if (columnAlias == null) {
