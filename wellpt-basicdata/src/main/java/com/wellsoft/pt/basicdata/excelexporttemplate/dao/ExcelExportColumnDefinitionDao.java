 ...
 */
package com.wellsoft.pt.basicdata.excelexporttemplate.dao;
 ...
 */
@Repository
public class ExcelExportColumnDefinitionDao extends HibernateDao<ExcelExportColumnDefinition, String> {
