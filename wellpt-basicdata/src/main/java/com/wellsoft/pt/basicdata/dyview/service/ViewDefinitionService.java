...
public interface ViewDefinitionService {
	 ...
	 * @return
	 */
	List<ViewDefinitionNew> searchViewDefinitionNew();
	 ...
	 * @return
	 */
	List<ViewDefinition> searchViewDefinitionByPermission();
	 ...
	 * @return
	 */
	List<ColumnDefinition> getViewColumnByPermission();
	 ...
	 * @return
	 */
	public abstract List<TreeNode> getViewNewAsTreeAsync(String id);
