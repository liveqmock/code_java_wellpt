 ...
 */
@Repository
public class ViewAttributeDao extends HibernateDao<ViewDefinition, String> {

	public ViewAttributeDao() {

	}

	public ViewDefinition getByUuid(String uuid) {
		return findUniqueBy("uuid", uuid);
	}

	public ViewDefinition getById(String id) {
		return findUniqueBy("id", id);
	}

	@Override
	public void delete(String viewUuid) {
		ViewDefinition view = get(viewUuid);
		super.delete(view);
	}
