 ...
 *
 */
public class DyviewConfigNew {

	public static final Map<String, String> DYVIEW_COLUMNCSS_CONDTION = new HashMap<String, String>();
	...
	public static final String DYVIEW_SELECT_TYPE_TEXT = "TEXT";
	public static final String DYVIEW_SELECT_TYPE_DATE = "DATE";
	public static final String DYVIEW_SELECT_TYPE_ORG = "ORG";
	public static final String DYVIEW_SELECT_TYPE_SELECT = "SELECT";
	public static final String DYVIEW_SELECT_TYPE_RADIO = "RADIO";
	public static final String DYVIEW_SELECT_TYPE_CHECKBOX = "CHECKBOX";
	public static final String DYVIEW_SELECT_TYPE_DIAlOG = "DIAlOG";
	...
	public static Map<String, String> getDyviewColumncssCondtion() {
		...
		return DYVIEW_COLUMNCSS_CONDTION;
	}
