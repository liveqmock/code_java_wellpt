 ...
 */
package com.wellsoft.pt.basicdata.datasource.facade;
 ...
 */
@Component
public class DataSourceApiFacade extends AbstractApiFacade {
	...
	public Long countForView(String dataSourceDefId, String whereClause, Map<String, Object> queryParams) {
		return dataSourceDataService.queryTotalByView(dataSourceDefId, whereClause);
	}
