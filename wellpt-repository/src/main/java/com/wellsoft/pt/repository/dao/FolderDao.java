...
public interface FolderDao {
	...
	void createFolder(String folderID, List<String> fileIDs ) throws IntrospectionException, IllegalAccessException, InvocationTargetException, FileNotFoundException;
	*/
