...
public class ExcelSheetCell {
	 ...
	 *            [当前单元格风格]
	 */
	public static void createCurrRowTitle(ExcelSheetRow sheetRow, ExcelWorkBook work, String[] firstRowValue,
			HSSFCellStyle style) {
	...
	public static void createCurrRowTitle(ExcelSheetRow sheetRow, ExcelWorkBook work, String[] firstRowValue) {
		createCurrRowTitle(sheetRow, work, firstRowValue, work.getWorkbook().createCellStyle());
	}
	 ...
	 *            [当前单元格风格]
	 */
	public static void createCurrRowRecord(ExcelSheetRow sheetRow, ExcelWorkBook work, List beanList,
			HSSFCellStyle style) {
		Object[] obj = null;
	...
	public static void createCurrRowRecord(ExcelSheetRow sheetRow, ExcelWorkBook work, List beanList) {
		createCurrRowRecord(sheetRow, work, beanList, work.getWorkbook().createCellStyle());
	}
