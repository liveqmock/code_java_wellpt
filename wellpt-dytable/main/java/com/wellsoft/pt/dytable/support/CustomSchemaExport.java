 ...
 *
 */
public class CustomSchemaExport {
	private static final CoreMessageLogger LOG = Logger.getMessageLogger(CoreMessageLogger.class,
			CustomSchemaExport.class.getName());
	private static final String DEFAULT_IMPORT_FILE = "/import.sql";

	public static enum Type {
		CREATE, DROP, NONE, BOTH;
	...
	public CustomSchemaExport(ServiceRegistry serviceRegistry, Configuration configuration) {
		...
		this.importFiles = ConfigurationHelper.getString(AvailableSettings.HBM2DDL_IMPORT_FILES,
				configuration.getProperties(), DEFAULT_IMPORT_FILE);
	...
	public CustomSchemaExport(MetadataImplementor metadata) {
		...
		this.importFiles = ConfigurationHelper.getString(AvailableSettings.HBM2DDL_IMPORT_FILES, serviceRegistry
				.getService(ConfigurationService.class).getSettings(), DEFAULT_IMPORT_FILE);
	 ...
	 */
	public CustomSchemaExport(Configuration configuration) {
	 ...
	 */
	@Deprecated
	public CustomSchemaExport(Configuration configuration, Properties properties) throws HibernateException {
		...
		this.importFiles = ConfigurationHelper.getString(AvailableSettings.HBM2DDL_IMPORT_FILES, properties,
				DEFAULT_IMPORT_FILE);
	 ...
	 * @throws HibernateException Indicates problem preparing for schema export.
	 */
	public CustomSchemaExport(Configuration configuration, Connection connection) throws HibernateException {
	...
	public CustomSchemaExport(ConnectionHelper connectionHelper, String[] dropSql, String[] createSql) {
	 ...
	 * @return this
	 */
	public CustomSchemaExport setOutputFile(String filename) {
		outputFile = filename;
		return this;
	}
	 ...
	 * @return this
	 */
	public CustomSchemaExport setDelimiter(String delimiter) {
	 ...
	 * @return this
	 */
	public CustomSchemaExport setFormat(boolean format) {
	 ...
	 * @return this
	 */
	public CustomSchemaExport setImportSqlCommandExtractor(ImportSqlCommandExtractor importSqlCommandExtractor) {
	 ...
	 * @return this
	 */
	public CustomSchemaExport setHaltOnError(boolean haltOnError) {
	...
	public void execute(Target output, Type type) {
		if ((outputFile == null && output == Target.NONE) || type == CustomSchemaExport.Type.NONE) {
			return;
		}
		exceptions.clear();
	...
	public static void main(String[] args) {
		try {
			...
			try {
				CustomSchemaExport se = new CustomSchemaExport(serviceRegistry, cfg).setHaltOnError(halt)
						.setOutputFile(outFile).setDelimiter(delim)
