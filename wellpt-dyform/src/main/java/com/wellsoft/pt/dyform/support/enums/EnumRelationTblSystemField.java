...
public enum EnumRelationTblSystemField {
	...
	data_uuid("property", "data_uuid", "data_uuid", "string", 255), // dataUuid字段
	...
	sort_order("property", "sort_order", "sort_order", "string", 255), // sort_order字段
	parent_uuid("property", "parent_uuid", "parent_uuid", "string", 255); //在表单数据中也存在父节点和子节点的关系,父节点和子节点的关系即通过该字段关联起来
